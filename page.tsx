...
import InteractiveLabDecoder from '@/content/hero/InteractiveLabDecoder';
          ...
          <div className="bg-gradient-to-br from-cyan-500/10 to-blue-500/10 border border-cyan-500/20 rounded-3xl p-8 lg:p-12">
            <div className="text-center">
              ...
              >
                ...
                <video
                  src="/mascots/lab-decoder.mp4"
                  preload="metadata"
                  className="hidden"
                  id="lab-decoder-video"
                />
                ...
                <div className="flex justify-center gap-6 mt-8">
                  <motion.button
                    ...
                    onClick={() => {
                      const video = document.getElementById('lab-decoder-video') as HTMLVideoElement;
                      if (video) {
                        video.play();
                      }
                    }}
                    className="px-8 py-4 bg-gradient-to-r from-blue-500 to-purple-500 text-white font-semibold rounded-xl hover:from-blue-600 hover:to-purple-600 transition-all hover:scale-105 hover:shadow-lg hover:shadow-blue-500/25 flex items-center gap-3"
                  >
                  ...
                  <motion.button
                    ...
                    onClick={() => window.location.href = '/chat?mascot=lab-decoder'}
                    className="px-8 py-4 bg-white/10 border-2 border-white/30 text-white font-semibold rounded-xl hover:bg-white/20 transition-all hover:scale-105 hover:shadow-lg hover:shadow-white/10 flex items-center gap-3"
                  >
              ...
              <div className="flex flex-wrap justify-center gap-4 mb-8">
                <div className="flex items-center gap-2 px-4 py-2 bg-cyan-500/20 border border-cyan-500/30 rounded-full">
                  ...
                  <span className="text-cyan-400 text-sm font-medium">AI Interpretation</span>
                </div>
                <div className="flex items-center gap-2 px-4 py-2 bg-blue-500/20 border border-blue-500/30 rounded-full">
                  ...
                  <span className="text-blue-400 text-sm font-medium">Trend Analysis</span>
                </div>
                <div className="flex items-center gap-2 px-4 py-2 bg-green-500/20 border border-green-500/30 rounded-full">
                  <FiHeart className="w-4 h-4 text-green-400" />
                  <span className="text-green-400 text-sm font-medium">Health Optimization</span>
                </div>
              </div>
              ...
              >
                <span>Go to Full Lab Decoder</span>
            ...
            <div className="text-center">
              ...
              >
                <Image
                  ...
                  alt="Root Mascot - Your family health pattern guide"
                  width={200}
                  height={200}
                  className="mx-auto rounded-2xl shadow-2xl"
                  priority
                ...
                <div className="flex justify-center gap-6 mt-8">
                  <motion.button
                    ...
                    transition={{ delay: 0.4, duration: 0.3 }}
                    onClick={() => {
                      const video = document.getElementById('root-video') as HTMLVideoElement;
                      if (video) {
                        video.play();
                      }
                    }}
                    className="px-8 py-4 bg-gradient-to-r from-green-500 to-emerald-500 text-white font-semibold rounded-xl hover:from-green-600 hover:to-emerald-600 transition-all hover:scale-105 hover:shadow-lg hover:shadow-green-500/25 flex items-center gap-3"
                  >
                    <FiPlay className="w-6 h-6" />
                    ▶ Learn Your Family Health Story
                  </motion.button>
                  ...
                  <motion.button
                    ...
                    animate={{ opacity: 1, y: 0 }}
                    transition={{ delay: 0.5, duration: 0.3 }}
                    onClick={() => window.location.href = '/chat?mascot=root'}
                    className="px-8 py-4 bg-white/10 border-2 border-white/30 text-white font-semibold rounded-xl hover:bg-white/20 transition-all hover:scale-105 hover:shadow-lg hover:shadow-white/10 flex items-center gap-3"
                  >
                    <FiMessageSquare className="w-6 h-6" />
                    💬 Ask Root
              ...
              <div className="flex flex-wrap justify-center gap-4 mb-8">
                <div className="flex items-center gap-2 px-4 py-2 bg-green-500/20 border border-green-500/30 rounded-full">
                  ...
                  <span className="text-green-400 text-sm font-medium">Generational Patterns</span>
                </div>
                <div className="flex items-center gap-2 px-4 py-2 bg-emerald-500/20 border border-emerald-500/30 rounded-full">
                  ...
                  <span className="text-emerald-400 text-sm font-medium">Genetic Insights</span>
                </div>
                <div className="flex items-center gap-2 px-4 py-2 bg-teal-500/20 border border-teal-500/30 rounded-full">
                  <FiShield className="w-4 h-4 text-teal-400" />
                  <span className="text-teal-400 text-sm font-medium">Prevention Focus</span>
                </div>
              </div>
              ...
              >
                <span>Go to Full Family Tree</span>
                <FiArrowRight className="w-5 h-5" />
              </Link>
            </div>
          </div>
