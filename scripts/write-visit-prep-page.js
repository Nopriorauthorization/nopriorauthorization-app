...
const outputPath = path.join(__dirname, '../src/app/(dashboard)/appointment-prep/page.tsx');

fs.writeFileSync(outputPath, pageContent, 'utf8');
console.log('✅ Visit Prep Intelligence page successfully written to', outputPath);
