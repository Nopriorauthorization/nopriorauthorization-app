...
const SOURCE = "skin-analysis-lead";

export function SkinAnalysisLeadCapture() {
  ...
  if (status === "done") {
    return (
      <div className="rounded-2xl border border-emerald-500/30 bg-emerald-500/5 p-8 text-center">
        <p className="text-lg font-bold text-emerald-400">You&apos;re in — here&apos;s your cheat sheet</p>
        ...
        {unlockUrl ? (
          ...
          >
            Open Skin Analysis Cheat Sheet →
          </a>
        ) : (
        ...
        <p className="mt-6 text-sm text-gray-500">
          Next step:{" "}
          <Link href="/shop/facial-training-manual" className="font-bold text-[#D4537E] hover:underline">
            The Complete Facial Training Manual — $10
          </Link>
        </p>
      </div>
    );
  ...
  return (
    <div className="rounded-2xl border border-[#D4537E]/30 bg-[#D4537E]/5 p-8">
      <h2 className="text-center font-serif text-2xl font-bold text-white sm:text-3xl">
        Get the free Skin Analysis Cheat Sheet
      </h2>
      <p className="mx-auto mt-3 max-w-lg text-center text-sm text-gray-400">
        One page: skin types, Fitzpatrick, Glogau scale, five facial zones, concern mapping, eight consult
        questions, and universal contraindications. Enter your email — we&apos;ll unlock the file instantly
        and add you to our list (no spam).
      </p>
      <form
      ...
      >
        ...
        >
          {status === "loading" ? "Sending..." : "Email me the cheat sheet"}
        </button>
      </form>
      ...
      <p className="mt-4 text-center text-xs text-gray-600">
        Then: level up with{" "}
        <Link href="/shop/facial-training-manual" className="text-[#D4537E] hover:underline">
          The Complete Facial Training Manual ($10)
        </Link>
        .
      </p>
