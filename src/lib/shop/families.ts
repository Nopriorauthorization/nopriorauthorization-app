...
export const SHOP_FAMILIES: ShopFamily[] = [
  {
    ...
    productSlugs: [
      ...
      "tirzepatide-vs-semaglutide-cheat-sheet",
      "glp1-titration-cheat-sheet",
  ...
  },
  {
    ...
    productSlugs: [
      ...
      "botox-dosing-zones-cheat-sheet",
  ...
  },
  {
    ...
    productSlugs: [
      ...
      "new-patient-intake-cheat-sheet",
      "treatment-room-setup-cheat-sheet",
    ],
  },
  {
  ...
  },
  {
    ...
    productSlugs: [
      ...
      "hormone-lab-reference-cheat-sheet",
      ...
      "pellet-therapy-dosing-cheat-sheet",
      "trt-men-vs-women-cheat-sheet",
    ],
  },
  {
    ...
    productSlugs: [
      ...
      "chemical-peel-reference-cheat-sheet",
      "fitzpatrick-classification-cheat-sheet",
      "microneedling-depth-cheat-sheet",
      "chemical-peel-patient-journey-kit",
      "microneedling-patient-journey-kit",
      "consent-laser-ipl",
      "consent-microneedling-rf",
      "ipl-laser-clinical-cheat-sheet",
      "laser-wavelength-reference-cheat-sheet",
